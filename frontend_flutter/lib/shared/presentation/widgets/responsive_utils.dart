...
class ResponsiveContainer extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final effectiveMaxWidth = maxWidth ?? ResponsiveUtils.getValue(
      context,
...
class ResponsiveSpacing extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final responsiveHeight = ResponsiveUtils.getResponsiveSpacing(context, height);
    final responsiveWidth = width != null ? ResponsiveUtils.getResponsiveSpacing(context, width!) : null;
