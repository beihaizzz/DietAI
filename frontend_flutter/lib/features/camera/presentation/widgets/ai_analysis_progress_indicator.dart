...
class _AIAnalysisProgressIndicatorState extends State<AIAnalysisProgressIndicator>
            ...
            return Transform.scale(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: const Color(0xFF2BAF74).withOpacity(0.3),
                      blurRadius: 12,
                      offset: const Offset(0, 4),
                    ),
                  ],
  ...
  Widget _buildCurrentStep() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF2BAF74).withOpacity(0.05),
                      ...
                      AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              color: const Color(0xFF2BAF74).withOpacity(0.1 * (1 - animValue)),
                              shape: BoxShape.circle,
                            ),
                          );
                        },
                ...
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isCompleted 
                      ...
                      : isCurrent 
                        ? const Color(0xFF2BAF74).withOpacity(0.7)
                        : Colors.grey[300],
                    shape: BoxShape.circle,
                  ),
                  child: Icon(
