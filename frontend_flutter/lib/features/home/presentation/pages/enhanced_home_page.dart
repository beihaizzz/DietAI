...
class _EnhancedHomePageState extends State<EnhancedHomePage>
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFF2BAF74).withOpacity(0.1),
                        borderRadius: BorderRadius.circular(20),
                      ),
                      child: Text(
  ...
  Widget _buildCalorieInfoItem(String label, int value, Color color, IconData icon) {
    return Row(
      children: [
        Container(
  ...
  Widget _buildNutritionProgressItem(String name, int current, int target, Color color, String unit) {
  ...
  Widget _buildFloatingActionButton() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF2BAF74).withOpacity(0.4),
            blurRadius: 16,
            offset: const Offset(0, 8),
          ),
        ],
