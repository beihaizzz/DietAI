...
class _HealthGoalsPageState extends ConsumerState<HealthGoalsPage> {
  ...
  Widget _buildActiveGoalsOverview(AsyncValue<List<HealthGoal>> activeGoalsAsync) {
    return Container(
          ...
          error: (error, _) => Center(
            child: Column(
              children: [
                ...
                const SizedBox(height: 16),
                ElevatedButton.icon(
                  onPressed: () => ref.read(healthGoalsProvider.notifier).refresh(),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final result = await ref.read(healthGoalsProvider.notifier).deleteHealthGoal(goal.id);
