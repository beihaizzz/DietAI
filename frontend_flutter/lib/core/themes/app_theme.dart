  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        errorStyle: AppTextStyles.withColor(AppTextStyles.bodySmall, AppColors.error),
        helperStyle: AppTextStyles.withColor(AppTextStyles.bodySmall, AppColors.textTertiary),
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        unselectedLabelStyle: AppTextStyles.withOpacity(AppTextStyles.labelSmall, 0.7),
      ...
      sliderTheme: SliderThemeData(
        ...
        valueIndicatorTextStyle: AppTextStyles.withColor(AppTextStyles.bodySmall, AppColors.textInverse),
        trackHeight: 6,
      ...
      chipTheme: ChipThemeData(
        ...
        secondaryLabelStyle: AppTextStyles.withColor(AppTextStyles.bodySmall, AppColors.textSecondary),
        brightness: Brightness.light,
        elevation: 0,
        pressElevation: 0,
      ...
      tabBarTheme: TabBarThemeData(
        ...
        unselectedLabelStyle: AppTextStyles.withOpacity(AppTextStyles.labelMedium, 0.7),
      ...
      tooltipTheme: TooltipThemeData(
        ...
        textStyle: AppTextStyles.withColor(AppTextStyles.bodySmall, AppColors.textInverse),
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
      ...
      badgeTheme: BadgeThemeData(
        ...
        smallSize: 8,
        largeSize: 16,
        textStyle: AppTextStyles.withColor(AppTextStyles.bodyXSmall, AppColors.textInverse),
      ...
      searchBarTheme: SearchBarThemeData(
        backgroundColor: MaterialStateProperty.all(AppColors.backgroundSecondary),
        surfaceTintColor: MaterialStateProperty.all(Colors.transparent),
        overlayColor: MaterialStateProperty.all(AppColors.primaryWithOpacity(0.05)),
        shadowColor: MaterialStateProperty.all(Colors.transparent),
        elevation: MaterialStateProperty.all(0),
        side: MaterialStateProperty.all(BorderSide(color: AppColors.border, width: 1)),
        ...
        textStyle: MaterialStateProperty.all(AppTextStyles.bodyMedium),
        hintStyle: MaterialStateProperty.all(AppTextStyles.inputHint),
  ...
  static ThemeData get darkTheme {
    return lightTheme.copyWith(
      ...
      appBarTheme: AppBarTheme(
        ...
        scrolledUnderElevation: 0.5,
        shadowColor: AppColors.shadowStrong,
        titleTextStyle: AppTextStyles.withColor(AppTextStyles.h5, AppColors.darkTextPrimary),
        centerTitle: false,
        iconTheme: IconThemeData(
...
class _CustomThemeExtension extends ThemeExtension<_CustomThemeExtension> {
  ...
  _CustomThemeExtension lerp(ThemeExtension<_CustomThemeExtension>? other, double t) {
    ...
    return _CustomThemeExtension(
      glassmorphismOverlay: Color.lerp(glassmorphismOverlay, other.glassmorphismOverlay, t)!,
      neumorphismHighlight: Color.lerp(neumorphismHighlight, other.neumorphismHighlight, t)!,
      neumorphismShadow: Color.lerp(neumorphismShadow, other.neumorphismShadow, t)!,
    );
  }
}